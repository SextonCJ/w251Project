...
parser.add_argument('-f', '--filename',   action='store', default='infer_cnn_lstm', help="name of the file, default is infer<datetime>.avi")
...
ltstm_model = '../../models/lstm/LSTM_20201205-094352_97.hdf5'

classifier = load_model(ltstm_model)
...
while True:
    ...
    if cnt<19:
        ...
        features = np.append(features, feats)
        pred_features = features[-25600:]
        pred_features = pred_features.reshape(1, 20, 1280)
